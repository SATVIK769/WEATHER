let cityInput = document.getElementById('city_input'),
    ...
    api_key = '14fc728e48f6d5e2fc621fb9cd5ba81a',
    ...
    fetch(WEATHER_API_URL).then(res => res.json()).then(data => {
        ...
        currentWeatherCard.innerHTML = `
            ...
            <div class="card-footer">
                <p><i class="fas fa-calendar-alt"></i> ${days[date.getDay()]}, ${date.getDate()} ${months[date.getMonth()]} ${date.getFullYear()}</p>
        ...
        sunriseCard.innerHTML = `
            ...
            <div class="sunrise-sunset">
                <div class="item">
                    <div class="icon"><i class="fas fa-arrow-up fa-4x"></i></div>
                    <div><p>Sunrise</p><h2>${sRiseTime}</h2></div>
                </div>
                <div class="item">
                    <div class="icon"><i class="fas fa-arrow-down fa-4x"></i></div>
...
function getUserCoordinates() {
    navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
            ...
            alert("Failed to get your location. Reason: " + error.message);
        }
    );
}
...
// Load weather for user's location by default
